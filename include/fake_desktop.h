	...
	private:
		...
		Result<DesktopHwnds> getDesktopHwnd()
		{
			...
			*/
			...
			if (NULL == Progman) return Result<DesktopHwnds>::Err("Progmanのウィンドウハンドル取得に失敗しました。");
			...
			if (NULL != SHELLDLL_DefView)
			{
				...
				{
					return Result<DesktopHwnds>::Err("壁紙とアイコンの分離に失敗しました。");
				}
			}
			...
			if (NULL == SHELLDLL_DefView)
			{
				return Result<DesktopHwnds>::Err("デスクトップのウィンドウハンドルの取得に失敗しました。");
			}
			...
			{
				return Result<DesktopHwnds>::Err("デスクトップのListViewのハンドルの取得に失敗しました。");
			}
			...
			{
				return Result<DesktopHwnds>::Err("壁紙のウィンドウハンドルの取得に失敗しました。");
			}
